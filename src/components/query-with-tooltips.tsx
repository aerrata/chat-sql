...
export function QueryWithTooltips({ query, queryExplanations }: { query: string; queryExplanations: QueryExplanation[] }) {
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger asChild>
                  <span className="inline-block hover:bg-primary/20 transition-colors duration-200 ease-in-out rounded-sm px-1 cursor-help">{segment.text}</span>
                </TooltipTrigger>
